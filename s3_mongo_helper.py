...
def initialize_s3():
    ...
    return bucket, s3 #, aws
    
def initialize_mongo():
    mongo_url = "mongodb+srv://"+os.environ.get("WHATSAPP_DB_USERNAME")+":"+os.environ.get("WHATSAPP_DB_PASSWORD")+"@tattle-data-fkpmg.mongodb.net/test?retryWrites=true&w=majority&ssl=true&ssl_cert_reqs=CERT_NONE"   
    cli = MongoClient(mongo_url)
    db = cli[os.environ.get("WHATSAPP_DB_NAME")]
    coll = db[os.environ.get("WHATSAPP_DB_COLLECTION")]
    return coll
